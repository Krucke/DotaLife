<div class="row">
  <div class="col-sm-6 mx-auto float-left sign">
    <h3>ВХОД</h3>
    <h6 style="color: white;">Используйте логин и пароль</h6>
  ...
  <div class="col-sm-5 mx-auto float-right sign">
    ...
    <h6 style="color: #DD163B;">Заполните поля для моментальной регистрация</h6>
